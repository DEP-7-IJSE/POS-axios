...
},{"process":"node_modules/process/browser.js"}],"ts/dto/pagination.ts":[function(require,module,exports) {
"use strict";
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"ts/search-orders.ts":[function(require,module,exports) {
"use strict";
...
var PAGE_SIZE = 6;
var PAGINATION = new pagination_1.Pagination((0, jquery_1.default)('.pagination'), PAGE_SIZE, 0, searchOrders);
searchOrders();
(0, jquery_1.default)('#btn-search').on('click', function (eventData) {
  eventData.preventDefault();
  searchOrders();
});
(0, jquery_1.default)("#txt-search").on('input', function () {
  searchOrders();
});
...
function searchOrders() {
  axios_1.default.get(ORDERS_SERVICE_API, {
    params: {
      ...
      size: PAGE_SIZE,
      q: (0, jquery_1.default)('#txt-search').val()
    }
  }).then(function (resp) {
    var count = +resp.headers['x-total-count'].split('/')[0];
...
},{"jquery":"node_modules/jquery/dist/jquery.js","./dto/pagination":"ts/dto/pagination.ts","axios":"node_modules/axios/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
