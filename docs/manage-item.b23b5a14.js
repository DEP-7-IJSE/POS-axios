...
},{"process":"node_modules/process/browser.js"}],"ts/dto/item.ts":[function(require,module,exports) {
"use strict";
...
},{}],"ts/manage-item.ts":[function(require,module,exports) {
"use strict";
...
function loadAllItems() {
  axios_1.default.get(ITEMS_SERVICE_API, {
    params: {
...
(0, jquery_1.default)('#btn-save').on('click', function (eventData) {
  ...
  var txtDesc = (0, jquery_1.default)('#txt-description');
  ...
  var validated = true;
  (0, jquery_1.default)('#txt-code, #txt-description, #txt-price, #txt-qty').removeClass('is-invalid');
  ...
  if (txtCode.attr('disabled')) {
    updateItem(new item_1.Item(code, description, +price, +qty));
    return;
  }

  saveItem(new item_1.Item(code, description, +price, +qty));
});
...
function updateItem(item) {
  (0, axios_1.default)({
    ...
    (0, jquery_1.default)("#tbl-items tbody tr.selected").find("td:nth-child(3)").text((0, jquery_1.default)("#txt-qty").val());
    (0, jquery_1.default)("#tbl-items tbody tr.selected").find("td:nth-child(4)").text((0, jquery_1.default)("#txt-price").val());
    (0, jquery_1.default)('#txt-code, #txt-description, #txt-price, #txt-qty').val('');
...
(0, jquery_1.default)('#tbl-items tbody').on('click', 'tr', function () {
  ...
  (0, jquery_1.default)('#txt-description').val(desc);
...
function deleteItem(code) {
  axios_1.default.delete(ITEMS_SERVICE_API, {
    params: {
      code: code
    }
  }).then(function () {
...
},{"axios":"node_modules/axios/index.js","jquery":"node_modules/jquery/dist/jquery.js","./dto/item":"ts/dto/item.ts","./dto/pagination":"ts/dto/pagination.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","ts/manage-item.ts"], null)
//# sourceMappingURL=/manage-item.b23b5a14.js.map