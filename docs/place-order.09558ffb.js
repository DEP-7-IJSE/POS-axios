...
},{"process":"node_modules/process/browser.js"}],"ts/tm/orderTM.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.OrderTM = void 0;

var OrderTM = function () {
  function OrderTM(code, description, qty, unitPrice, total) {
    this.code = code;
...
exports.OrderTM = OrderTM;
},{}],"ts/dto/order.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.OrderDetails = exports.Order = void 0;

var Order = function () {
  function Order(orderId, orderDate, customerId, orderDetails) {
...
var OrderDetails = function () {
  function OrderDetails(itemCode, unitPrice, qty) {
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"ts/place-order.ts":[function(require,module,exports) {
"use strict";
...
var orderTM_1 = require("./tm/orderTM");

var order_1 = require("./dto/order");
...
var ITEM_SERVICE_API = BASE_API + "/items";
var PAGE_SIZE = 6;
var PAGINATION = new pagination_1.Pagination((0, jquery_1.default)('.pagination'), PAGE_SIZE, 0, loadAllOrders);
var orders = [];
var customers = [];
var items = [];
var totalOrders = 0;
...
loadAllItems();
generateOrderId();
(0, jquery_1.default)(window).ready(function () {
  (0, jquery_1.default)('#cmb-customer-ids, #cmb-item-codes').val(''); //TODO:
});

function generateOrderId() {
  axios_1.default.get(ORDERS_SERVICE_API, {
    params: {
    ...
    (0, jquery_1.default)('#order-id h1').text(newOrderId);
  }).catch(function (err) {
...
function loadAllCustomers() {
  axios_1.default.get(CUSTOMER_SERVICE_API).then(function (resp) {
    customers = resp.data;
    (0, jquery_1.default)('#cmb-customer-ids option').remove();
    customers.forEach(function (c) {
      var rowHtml = "<option>" + c.id + "</option>";
      (0, jquery_1.default)('#cmb-customer-ids').append(rowHtml);
    });
  }).catch(function (err) {
...
(0, jquery_1.default)('#cmb-customer-ids').on('change', function () {
  for (var _i = 0, customers_1 = customers; _i < customers_1.length; _i++) {
    var customer = customers_1[_i];

    if (customer.id === (0, jquery_1.default)(this).val()) {
      (0, jquery_1.default)('#txt-customer-name').val(customer.name);
      break;
    }
  }
});
...
function loadAllItems() {
  axios_1.default.get(ITEM_SERVICE_API).then(function (resp) {
    items = resp.data;
    (0, jquery_1.default)('#cmb-item-codes option').remove();
    items.forEach(function (c) {
      var rowHtml = "<option>" + c.code + "</option>";
      (0, jquery_1.default)('#cmb-item-codes').append(rowHtml);
    });
  }).catch(function (err) {
...
(0, jquery_1.default)('#cmb-item-codes').on('change', function () {
  for (var _i = 0, items_1 = items; _i < items_1.length; _i++) {
    var item = items_1[_i];

    if (item.code === (0, jquery_1.default)(this).val()) {
      (0, jquery_1.default)('#txt-item-desc').val(item.description);
      (0, jquery_1.default)('#txt-price').val(item.unitPrice);
      (0, jquery_1.default)('#txt-qty-hand').val(item.qtyOnHand);
      break;
    }
  }
});
...
function loadAllOrders() {
  (0, jquery_1.default)('#tbl-orders tbody tr').remove();
  var start = PAGINATION.selectedPage == 1 ? 0 : 1 + (PAGINATION.selectedPage - 1) * PAGE_SIZE;
  var end = PAGINATION.selectedPage === 1 ? orders.length + start : orders.length === start ? start + 1 : orders.length - start + start;
  console.log(start, end); //orders.length * selectedPage: start + PAGE_SIZE
  ...
  for (var index = start; index < end; index++) {
    ...
    (0, jquery_1.default)('#tbl-orders tbody').append(rowHtml);
  }
...
(0, jquery_1.default)('#btn-save').on('click', function (eventData) {
  ...
  var cmbCode = (0, jquery_1.default)('#cmb-item-codes');
  var txtDesc = (0, jquery_1.default)('#txt-item-desc');
  var txtPrice = (0, jquery_1.default)('#txt-price');
  var txtQty = (0, jquery_1.default)('#txt-qty');
  var txtQtyHand = (0, jquery_1.default)('#txt-qty-hand');
  var code = cmbCode.val().trim();
  var description = txtDesc.val().trim();
  var price = txtPrice.val().trim();
  var qty = txtQty.val().trim();
  var qtyHand = txtQtyHand.val().trim();
  var validated = true;
  (0, jquery_1.default)('#txt-qty').removeClass('is-invalid');
  ...
  if ((0, jquery_1.default)('#tbl-orders tbody tr').hasClass('selected')) {
    (0, jquery_1.default)("#tbl-orders tbody tr.selected").find("td:nth-child(2)").text((0, jquery_1.default)("#txt-description").val());
    (0, jquery_1.default)("#tbl-orders tbody tr.selected").find("td:nth-child(3)").text((0, jquery_1.default)("#txt-qty").val());
    (0, jquery_1.default)("#tbl-orders tbody tr.selected").find("td:nth-child(4)").text((0, jquery_1.default)("#txt-price").val());
    return;
  }

  saveOrder(new orderTM_1.OrderTM(code, description, +qty, +price, +qty * +price));
  var total = 0;
  ...
  (0, jquery_1.default)('#order-total').text(total);
});
...
function saveOrder(order) {
  ...
  (0, jquery_1.default)('#cmb-item-codes, #txt-item-desc, #txt-price, #txt-qty-hand, #txt-qty').val('');
  (0, jquery_1.default)('#cmb-item-codes').trigger('focus');
}
...
(0, jquery_1.default)('#btn-place').on('click', function () {
  var orderId = (0, jquery_1.default)('#order-id h1').text();
  var cusId = (0, jquery_1.default)('#cmb-customer-ids').val();
  var orderDetails = [];

  for (var _i = 0, orders_2 = orders; _i < orders_2.length; _i++) {
    var order = orders_2[_i];
    console.log(new order_1.OrderDetails(order.code + '', +order.unitPrice, +order.qty));
    orderDetails.push(new order_1.OrderDetails(order.code + '', +order.unitPrice, +order.qty));
  }

  placeOrder(new order_1.Order(orderId, today, cusId + '', orderDetails));
});
...
(0, jquery_1.default)('#tbl-orders tbody').on('click', 'tr', function () {
  var code = (0, jquery_1.default)(this).find("td:first-child").text();
  var desc = (0, jquery_1.default)(this).find("td:nth-child(2)").text();
  var qty = (0, jquery_1.default)(this).find("td:nth-child(3)").text();
  var price = (0, jquery_1.default)(this).find("td:nth-child(4)").text();
  (0, jquery_1.default)('#cmb-item-codes').val(code);
  (0, jquery_1.default)('#txt-item-desc').val(desc);
  (0, jquery_1.default)('#txt-price').val(price);
  (0, jquery_1.default)('#txt-qty').val(qty);
  ...
  (0, jquery_1.default)("#tbl-orders tbody tr").removeClass('selected');
  (0, jquery_1.default)(this).addClass('selected');
});
(0, jquery_1.default)('#tbl-orders tbody').on('click', '.trash', function (eventData) {
  if (confirm('Are you sure to delete?')) {
    deleteOrder((0, jquery_1.default)(eventData.target).parents("tr").find('td:first-child').text());
  }
});
...
},{"jquery":"node_modules/jquery/dist/jquery.js","./tm/orderTM":"ts/tm/orderTM.ts","./dto/order":"ts/dto/order.ts","./dto/pagination":"ts/dto/pagination.ts","axios":"node_modules/axios/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","ts/place-order.ts"], null)
//# sourceMappingURL=/place-order.09558ffb.js.map